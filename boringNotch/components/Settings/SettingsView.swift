        ...
        NavigationSplitView {
            List(selection: $selectedTab) {
                ...
                NavigationLink(value: "HUD") {
                    Label("提示", systemImage: "dial.medium.fill")
                }
...
//                }
                NavigationLink(value: "Shelf") {
                    Label("暂存", systemImage: "books.vertical")
                }
            ...
            Section {
                HStack {
                    VStack(alignment: .leading, spacing: 2) {
                        Text("替换系统 HUD")
                            .font(.headline)
                        Text("用自定义设计替换 macOS 标准音量、显示亮度和键盘亮度 HUD。")
                            .font(.subheadline)
                            .foregroundStyle(.secondary)
        ...
        Form {
            ...
            Section {
                ...
                Picker(
                    ...
                    Text("所有应用隐藏").tag(HideNotchOption.always)
                    Text("仅媒体应用隐藏").tag(
            ...
            Section {
                ...
                Text("自定义音乐播放器中显示的控制按钮。音量控件在激活时会展开。")
                    .font(.caption)
                    .foregroundStyle(.secondary)
            }
        }
    ...
    var body: some View {
        Form {
            ...
            Section {
                ...
                Text("选择从暂存区分享文件时使用的服务。点击暂存按钮选择文件，或拖拽文件到暂存区立即分享。")
                    .font(.caption)
                    .foregroundColor(.secondary)
            }
        }
